...
export function Navbar() {
  ...
  return (
    <header className="w-full bg-white dark:bg-zinc-900 bg border-b-4 border-zinc-100 dark:border-zinc-700">
      <div className="w-full relative h-40 md:h-auto max-w-screen-lg mx-auto pt-12 px-4 md:px-8 flex items-start justify-end md:justify-between md:flex-row">
        ...
        <Image
          src="/logo.png"
          alt="Telescope"
          className="flex items-end absolute md:relative left-4 md:left-0 bottom-0 w-56 md:w-80"
          width={320}
          height={80}
